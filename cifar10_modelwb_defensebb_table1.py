...
def analyse_internals(atk, atk_id, rlevel1, rlevel2):
    ...
    #for images, labels in testloader:
        ...
        print(" Randomized sym accuracy after attack :{}".format(100 * float(randomized_robust) / total))
        #print(" Randomized Fixed sym accuracy after attack :{}".format(100 * float(randomized_fixed_robust) / total))
...
if __name__ == '__main__':
    ...
    testloader_subset_vanilla = torch.utils.data.DataLoader(testset_subset, batch_size=64, shuffle=False)
